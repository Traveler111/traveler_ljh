 ...
 */
public class MesFragmentMesAdapter extends BaseAdapter {
    private List<FriendOne>friends1;
    private Context c;
    private ImageView img;
    private TextView name;
    private TextView desc;

    public MesFragmentMesAdapter(Context c , List<FriendOne> friends1) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        desc.setText(friends1.get(position).getMisoshu().toString());
        return convertView;
    }
}
